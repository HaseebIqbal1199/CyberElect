...
public:
    ElectionManager electionManager; // Make public for direct access
    
    VotingSystem();
    ~VotingSystem();
    
    bool registerVoter(std::string username, std::string password, std::string name, 
                       std::string cnic = "", std::string dob = "", std::string city = "");    bool registerAdmin(std::string username, std::string password, std::string name);
    ...
    bool addCandidate(std::string electionId, std::string name, std::string partyAffiliation, std::string partySymbol = "");    void viewResults(std::string electionId);
